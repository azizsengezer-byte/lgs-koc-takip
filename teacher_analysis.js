  ...
  return `
    ...
    ` : `
      ...
      <div class="card" style="margin-top:16px">
        <div class="card-title">📚 Bu Hafta Ders Bazlı Soru Dağılımı</div>
