    ...
    <div style="background:var(--surface);border-radius:20px 20px 0 0;padding:22px 18px 36px;width:100%;max-width:480px;max-height:92vh;overflow-y:auto">
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px">
        <button id="_gBtn_yapildi" onclick="
          ...
          style="flex:1;padding:9px;border-radius:10px;background:var(--accent);border:1.5px solid var(--accent);color:#fff;font-weight:700;font-size:0.82rem;cursor:pointer"><svg style="vertical-align:middle" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Görüşme Yapıldı</button>
...
async function psychReportPage() {
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px">
            ...
            <div style="display:flex;align-items:center;gap:6px">
              ...
              <button onclick="deleteGorusme('${sName}','${sUid}',${gercekIdx})"
                style="width:26px;height:26px;border-radius:7px;background:#ff658420;border:1px solid #ff658444;color:#ff6584;font-size:0.8rem;cursor:pointer;display:flex;align-items:center;justify-content:center"><svg style="vertical-align:middle" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg></button>
            </div>
          </div>
  ...
  const hedefHtml = (data.hedef||data.hedefOkul) ? `
    <div class="card" style="margin-bottom:14px">
      <div class="card-title"><svg style="vertical-align:middle;margin-right:6px" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg> Öğrencinin Hedefleri</div>
  ...
  const motorHtml = (motorSonuc.insights.length > 0 || motorSonuc.positives.length > 0 || motorSonuc.vaka) ? `
    <div class="card" style="margin-bottom:12px;border:1px solid #6c63ff44;background:linear-gradient(135deg,#6c63ff0a,#fd79a80a)">
      ...
      ${motorSonuc.insights.map(ins => {
        const r = _renkler[ins.ton] || _renkler.informative;
        return `
  ...
  const heatMapHtml = `
    <div class="card" style="margin-bottom:14px">
      <div class="card-title"><svg style="vertical-align:middle;margin-right:6px" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> Psikolojik Isı Haritası — Son 30 Gün</div>
